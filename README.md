...
This library was created based on solutions for problems from the MIPT [concurrency course](https://gitlab.com/Lipovsky/concurrency-course). Original design (this readme in particular): [await](https://gitlab.com/Lipovsky/await) by [Roman Lipovsky](https://gitlab.com/Lipovsky).
