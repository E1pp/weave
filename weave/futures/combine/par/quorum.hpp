...
Future<std::vector<traits::ValueOf<InputFuture>>> auto Quorum(
  ...
  using QuorumFuture = futures::thunks::Join<true, ValueType, thunks::QuorumControlBlock, Storage, thunks::detail::TaggedVector, InputFuture>;
...
Quorum(size_t threshold, First f1, Suffix... fs) {
  ...
  using QuorumFuture = futures::thunks::Join<true, ValueType, thunks::QuorumControlBlock, Storage, thunks::detail::TaggedTuple, First, Suffix...>;
