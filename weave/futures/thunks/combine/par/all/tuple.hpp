...
class AllControlBlock<OnHeap, Cons, detail::TaggedTuple, Futures...> final: public detail::JoinBlock<true, AllControlBlock<true, Cons, detail::TaggedTuple, Futures...>, detail::JoinAll<true>, std::tuple<traits::ValueOf<Futures>...>, Cons, detail::TaggedTuple, Futures...> {
 public:
  using ValueType = std::tuple<traits::ValueOf<Futures>...>;
  using Base = detail::JoinBlock<true, AllControlBlock<true, Cons, detail::TaggedTuple, Futures...>, detail::JoinAll<true>, ValueType, Cons, detail::TaggedTuple, Futures...>;

  template<typename InterStorage>
  requires std::is_constructible_v<Base, Cons&, InterStorage>
  AllControlBlock(size_t, Cons& cons, InterStorage storage) : Base(cons, std::move(storage)){
  }
...
class AllControlBlock<false, Cons, detail::TaggedTuple, Futures...> final: public detail::JoinBlock<false, AllControlBlock<false, Cons, detail::TaggedTuple, Futures...>, detail::JoinAll<false>, std::tuple<traits::ValueOf<Futures>...>, Cons, detail::TaggedTuple, Futures...> {
 public:
  using ValueType = std::tuple<traits::ValueOf<Futures>...>;
  using Base = detail::JoinBlock<false, AllControlBlock<false, Cons, detail::TaggedTuple, Futures...>, detail::JoinAll<false>, ValueType, Cons, detail::TaggedTuple, Futures...>;
